          ...
          <div className="px-7 py-6">
            ...
            <div className="border-t border-[#EAF4ED] pt-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <a
                ...
                className="shrink-0 flex items-center gap-2 bg-[#25D366] text-white font-sans text-sm font-semibold px-5 py-3 rounded-full hover:bg-[#20bd5a] transition-colors duration-200 shadow-sm"
