...
export default function CollapsibleSection({
  ...
  return (
    <div>
      ...
      <button
        className="md:hidden w-full flex items-center justify-between px-6 py-4 bg-white border-b border-sage-light shadow-sm"
        onClick={() => setIsOpen((prev) => !prev)}
        aria-expanded={isOpen}
      >
        <div className="flex items-center gap-3">
          <span
            className="w-1.5 h-5 rounded-full bg-sage"
            aria-hidden="true"
          />
